# Scottish_Snowpatches_Data_Tool.py
# Python script to retrieve image data using Sentinel Hub API
...
from utils import read_bbox_geojson, read_point_geojson, plot_map_with_image, get_coords_from_sel, request_sentinel_image, request_sentinel_scm
...
# Structure page
st.subheader("Scottish Snowpatches Data Tool")
